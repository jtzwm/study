package com.zhuwm.mybatis.controller;
...
import com.zhuwm.mybatis.service.ProjectsService;
import com.zhuwm.ssm.controller.validation.ValidGroup1;
...
public class ProjectsController {
	...
	// 商品查询
	@RequestMapping("/queryProjects.action")
	public ModelAndView queryProjects(HttpServletRequest request,
		...
		Projects projects = projectsService.findProjects(null);
	...
	@RequestMapping(value = "/itemEdit.action", method = { RequestMethod.POST,
			RequestMethod.GET })
...
/*	@RequestMapping("/itemsSubmit.action")

...
var	rte_toolbar = {
	//s1				: {separator: true},
	bold			: {command: 'bold', tags:['b', 'strong'], hint:"粗体"},
	italic			: {command: 'italic', tags:['i', 'em'], hint:"斜体"},
	// strikeThrough	: {command: 'strikethrough', tags: ['s', 'strike'] },
	underline		: {command: 'underline', tags: ['u'], hint:"下划线"},
	s2				: {separator: true },
	justifyLeft   	: {command: 'justifyleft', hint:"左对齐"},
	justifyCenter	: {command: 'justifycenter', hint:"居中"},
	justifyRight	: {command: 'justifyright', hint:"右对齐"},
	// justifyFull		: {command: 'justifyfull'},
	s3				: {separator : true},
	indent			: {command: 'indent', hint:"前缩进"},
	outdent			: {command: 'outdent', hint:"后缩进"},
	// s4				: {separator : true},
	// subscript		: {command: 'subscript', tags: ['sub']},
	// superscript		: {command: 'superscript', tags: ['sup']},
	s5				: {separator : true },
	orderedList		: {command: 'insertorderedlist', tags: ['ol'] , hint:"编号"},
	unorderedList	: {command: 'insertunorderedlist', tags: ['ul'] , hint:"项目符号"},
	s6				: {separator : true },
...
<select>\
	...
	//link			: {exec: lwrte_link, tags: ['a'] , hint:"插入超链接" },
	//unlink			: {command: 'unlink' , hint:"取消超链接"},
	s8				: {separator : true },
	removeFormat	: {exec: lwrte_unformat , hint:"清除格式"},
	// word			: {exec: lwrte_cleanup_word},
	clear			: {exec: lwrte_clear , hint:"清空"}
};
